...
subtitle: "Oxford DSPI Seminar Series<br>February 2026"
...
> What are the political consequences of higher energy prices, and under what conditions do they lead to backlash against climate policy?
...
::: {.incremental}
- **Material Shocks:** Economic shocks shape political preferences under certain conditions.
- **Populist Radical Right Parties:** PRR parties as issue entrepreneurs -- climate policy as a wedge issue.
- **Green Backlash and Climate Policy:** Backlash when costs are salient and unevenly distributed.
:::
...
# PRR Parties and Climate Change Policies

<br>

::: {.incremental}
- Climate policy is highly salient but complex, making it vulnerable to politicization 
- There's growing evidence that PRR parties oppose climate policies and exploit public concerns about their costs
- Mainstream parties often avoid contesting climate policy, creating space for PRR parties to frame it as a threat to economic well-being, security, sovereignty etc. [@van2014exploiting; @dickson2024going]
- Climate policies can provoke political backlash when costs are salient and unequal [@stokes2016electoral; @colantone2024political; @Bosetti2025]
  + For example: 
    - Taxes on household gas consumption [@voeten2024energy]
...
::: {.incremental}
1. **Energy Price Shock:** Large, exogenous increase in household energy prices  
2. **Rhetorical Linkage:** PRR parties explicitly link energy bills → Net Zero  
3. **Heterogeneous Exposure:** Spatial variation in energy inefficiency → differential exposure to price shock  
4. **Voter Behavior:** Individuals in energy-inefficient areas → increased PRR support post-shock  
5. **Amplification:** Stronger effects among gas-dependent households  
6. **Mechanism:** Shift in environmental attitudes among affected individuals 
:::
