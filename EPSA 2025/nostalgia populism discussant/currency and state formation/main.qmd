...
This is an insightful paper that makes a valuable contribution to the literature on constitutional referendums, political economy, and voter behavior. Its key strengths lie in:
...
- Rich, Multi-Faceted Data: The use of a two-wave panel survey conducted before and after the referendum is a significant asset. Combining this with knowledge questions, retrospective evaluations, and survey experiments provides a robust, multi-method approach to answering the research questions.
